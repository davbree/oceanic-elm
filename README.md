...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/6089c2383caa2100169a6f3e
...
To start editing your site, you can use the Sanity interface at https://oceanic-elm-9c238.sanity.studio/.
...
Generated at `2021-04-28T20:16:33.632Z` by Stackbit version `0.3.51`.